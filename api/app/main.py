...
from app.routers import auth, coaching, health, language, mastery, mission, objectives, onboarding, paths, progress, recommendations, reviews, submissions, system_design, today
