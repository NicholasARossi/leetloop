...
const leetcodeNav: NavItem[] = [
  ...
  { name: 'ML Coding', href: '/ml-coding', icon: MLCodingIcon },
...
const languageNav: NavItem[] = [
  ...
  { name: 'Book Progress', href: '/language/book-progress', icon: BookProgressIcon },
  { name: 'Reviews', href: '/language/reviews', icon: ReviewsIcon },
]

const onsitePrepNav: NavItem[] = [
  { name: 'Dashboard', href: '/onsite-prep', icon: OnsiteDashboardIcon },
  { name: 'LP Stories', href: '/onsite-prep/lp', icon: LPStoriesIcon },
  { name: 'ML Breadth', href: '/onsite-prep/breadth', icon: MLBreadthIcon },
  { name: 'ML Depth', href: '/onsite-prep/depth', icon: MLDepthIcon },
  { name: 'System Design', href: '/onsite-prep/design', icon: SystemDesignDashboardIcon },
]

const lifeOpsNav: NavItem[] = [
  { name: 'Checklist', href: '/life-ops', icon: ChecklistIcon },
  { name: 'Manage Tasks', href: '/life-ops/manage', icon: ManageTasksIcon },
  { name: 'Stats', href: '/life-ops/stats', icon: StatsIcon },
]
...
const navByMegaview: Record<Megaview, { label: string; items: NavItem[] }> = {
  ...
  'onsite-prep': { label: 'Onsite Prep', items: onsitePrepNav },
  'life-ops': { label: 'Life Ops', items: lifeOpsNav },
}
...
function BookProgressIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function MLCodingIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function OnsiteDashboardIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function LPStoriesIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function MLBreadthIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function MLDepthIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function ManageTasksIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
